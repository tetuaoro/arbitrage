...
exports.getNameExchange = function (address) {
    for (var _i = 0, EXCHANGE_INFOS_2 = exports.EXCHANGE_INFOS; _i < EXCHANGE_INFOS_2.length; _i++) {
        var ex = EXCHANGE_INFOS_2[_i];
        if (exports.eqAddress(ex.factory, address) ||
            exports.eqAddress(ex.router, address) ||
            typeof ex.pairs.find(function (p) { return exports.eqAddress(p, address); }) != 'undefined')
            return ex.name;
    }
};
exports.getRouterContractFromPairAddress = function (pairAddress) {
    var i = 0;
    for (var _i = 0, EXCHANGE_INFOS_3 = exports.EXCHANGE_INFOS; _i < EXCHANGE_INFOS_3.length; _i++) {
        var ex = EXCHANGE_INFOS_3[_i];
        if (typeof ex.pairs.find(function (p) { return exports.eqAddress(p, pairAddress); }) != 'undefined')
            return exports.ROUTERS[i];
        i++;
    }
};
